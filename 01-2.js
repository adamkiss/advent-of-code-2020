...
if (found) {
  console.log(`Found: [${firstIndex}] ${input[firstIndex]} ⨉ [${secondIndex}] ${input[secondIndex]} ⨉ [${thirdIndex}] ${input[thirdIndex]} = ${input[firstIndex] * input[secondIndex] * input[thirdIndex]}`)
} else {
